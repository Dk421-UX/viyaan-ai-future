...
export default function ResultPage() {
  ...
  useEffect(() => {
    ...
    setEntry(JSON.parse(raw) as { inputText: string; intensityBefore: number; generatedText: string })
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      <div
        className={`w-full max-w-xl transition-all duration-700 ${revealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
      >
